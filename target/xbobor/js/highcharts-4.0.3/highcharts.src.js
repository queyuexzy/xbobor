...
SVGElement.prototype = {
	...
	colorGradient: function (color, prop, elem) {
		...
		if (gradName) {
			...
			// Correct the radial gradient for the radial reference config.system
...
var ColumnSeries = extendClass(Series, {
	...
	/**
	 * Translate each point to the plot area coordinate config.system and find shape positions
	 */
	translate: function () {
		var series = this,
			chart = series.chart,
